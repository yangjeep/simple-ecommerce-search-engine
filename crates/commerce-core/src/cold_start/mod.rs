...
pub use profile::{
    ...
    compile_lexicon_with_brand_canonicalizer, compile_lexicon_with_promoted_hyponyms,
    product_type_hyponym_groups, promote_all_hyponym_candidates_unadjudicated, CatalogProfile,
};
